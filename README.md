...
`salon_0.3.5-1_all.deb` from the [latest release][latest-release] and let APT
resolve the dependencies:

```sh
sudo apt install ~/Downloads/salon_0.3.5-1_all.deb
```

It is `Architecture: all` and works on both AMD64 and ARM64.

**Offline Flatpak bundle.** `Salon-v0.3.5-x86_64.flatpak` or
